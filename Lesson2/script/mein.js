...
// - Створити 3 об'єкти які описують книги. Поля об'єкту : title ,pageCount, genre.
// let book = {title: `Sport Dayly` , pageCounter: 100 , genre: `spoet` };
// let book2 = {title: `Harry Potter` , pageCounter: 200, genre: `fantastic` };
// let book3 = {title: `ABC`, pageCounter: 300, genre: `learning` };

// - Створити 3 об'єкти які описують книги. Поля об'єкту : title ,pageCount, genre, authors. Поле "автори" - являється  масивом. Кожен автор має поля name та age.
let book = {title: `Sport Dayly` , pageCounter: 100 , genre: `spoet` [{name: `артур`}] };
let book2 = {title: `Harry Potter` , pageCounter: 200, genre: `fantastic` };
let book3 = {title: `ABC`, pageCounter: 300, genre: `learning` };
...
//
//
//     - з файлу arrays.js (лежить в папці 2023 plan ) взяти масив coursesAndDurationArray. За допомоги іф перевірити кожен його елемент на тривалість навчання. У випадку якщо тривалість довша за 5 місяців вивести в консоль